...
class News extends Model {
  ...
  const News._internal({required this.id, title, content, image, video, createdAt, updatedAt}): _title = title, _content = content, _image = image, _video = video, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory News({String? id, String? title, String? content, String? image, String? video}) {
  ...
  News copyWith({String? id, String? title, String? content, String? image, String? video}) {
    return News._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'content': _content, 'image': _image, 'video': _video, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
